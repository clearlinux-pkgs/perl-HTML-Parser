...
%prep
%setup -q -n HTML-Parser-3.78
cd %{_builddir}/HTML-Parser-3.78
...
cp %{_builddir}/HTML-Parser-3.78/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTML-Parser/1f708223a66ca13060f180a7da8c5479b89a8b00
if test -f Makefile.PL; then
