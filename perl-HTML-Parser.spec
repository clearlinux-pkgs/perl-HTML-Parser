...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTML-Parser-3.82.tar.gz
...
%prep
%setup -q -n HTML-Parser-3.82
cd %{_builddir}/HTML-Parser-3.82
...
cp %{_builddir}/HTML-Parser-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTML-Parser/0c67d991d07a9c383d551a4b2ebdd329625f02e3 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-HTML-Parser/0c67d991d07a9c383d551a4b2ebdd329625f02e3
